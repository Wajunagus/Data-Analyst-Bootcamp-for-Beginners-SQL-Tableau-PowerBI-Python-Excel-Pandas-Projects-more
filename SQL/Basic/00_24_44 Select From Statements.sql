...
Everything should be returned, so all 9 rows should be returned,
& thats coz every single 1 of these are unique. */
Select Distinct(EmployeeID)
From AlexTheAnalyst..EmployeeDemographics

/*
So, there's only going to be 2 results, the male & the female.
And that's coz there's only 2 distinct values in that column. */
...
/*
Max, Min, & Avg
	The only column here where it would be useful to do it on is age,
